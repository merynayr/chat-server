...
//go:generate minimock -i github.com/merynayr/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmSendMessage *mChatServiceMockSendMessage) ExpectMessageParam2(message *model.MessageInfo) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
